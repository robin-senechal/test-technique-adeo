...
test("Filter countries data with filter 'ry'", () => {
  const expectation = [
    {
      name: "Uzuzozne",
      people: [
  ...
  expect(filterCountriesByAnimalName(data, "ry")).toEqual(expectation);
});

test("Count countries", () => {
  const expectation = [
    {
      name: "Dillauti [5]",
      people: [
  ...
  expect(count(data)).toEqual(expectation);
});

test("Filter and count countries data with filter 'ry'", () => {
  const expectation = [
    {
      name: "Uzuzozne [1]",
      people: [
  ...
  expect(count(filterCountriesByAnimalName(data, "ry"))).toEqual(expectation);
});
